...
macro(find_package_or_conan PKG)
  ...
  string(REPLACE ";" " " ADDITIONAL_PARAMS "${UNPARSED_ARGUMENTS}")
  ...
  option(USE_CONAN_${PKG} "Use conan for dependency ${PKG}" ${USE_CONAN})
  if(USE_CONAN AND USE_CONAN_${PKG})
    set(CONAN_OR_CMAKE_${PKG} ${CONAN_PACKAGE_NAME})
  else()
    find_package(${PKG} ${ADDITIONAL_PARAMS})
    set(CONAN_OR_CMAKE_${PKG} ${PKG})
  endif()
endmacro()
