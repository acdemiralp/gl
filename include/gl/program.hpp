...
public:
  ...
  explicit program(GLuint id) : id_(id), managed_(false)
  {

  }
  program(const program&  that) = delete;
  program(      program&& temp) noexcept : id_(std::move(temp.id_)), managed_(std::move(temp.managed_))
  {
    temp.id_ = invalid_id;
    temp.managed_ = false;
  }
  ...
  void set_uniform_matrix_22f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix2fv(id_, location, static_cast<GLsizei>(value.size() / 4), transpose, value.data());
  }
  void set_uniform_matrix_33f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix3fv(id_, location, static_cast<GLsizei>(value.size() / 9), transpose, value.data());
  }
  void set_uniform_matrix_44f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix4fv(id_, location, static_cast<GLsizei>(value.size() / 16), transpose, value.data());
  }
  void set_uniform_matrix_23f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix2x3fv(id_, location, static_cast<GLsizei>(value.size() / 6), transpose, value.data());
  }
  void set_uniform_matrix_32f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix3x2fv(id_, location, static_cast<GLsizei>(value.size() / 6), transpose, value.data());
  }
  void set_uniform_matrix_24f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix2x4fv(id_, location, static_cast<GLsizei>(value.size() / 8), transpose, value.data());
  }
  void set_uniform_matrix_42f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix4x2fv(id_, location, static_cast<GLsizei>(value.size() / 8), transpose, value.data());
  }
  void set_uniform_matrix_34f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix3x4fv(id_, location, static_cast<GLsizei>(value.size() / 12), transpose, value.data());
  }
  void set_uniform_matrix_43f(GLint location, const std::vector<GLfloat>& value, bool transpose)
  {
    glProgramUniformMatrix4x3fv(id_, location, static_cast<GLsizei>(value.size() / 12), transpose, value.data());
  }
  
  void set_uniform_matrix_22d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix2dv(id_, location, static_cast<GLsizei>(value.size() / 4), transpose, value.data());
  }
  void set_uniform_matrix_33d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix3dv(id_, location, static_cast<GLsizei>(value.size() / 9), transpose, value.data());
  }
  void set_uniform_matrix_44d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix4dv(id_, location, static_cast<GLsizei>(value.size() / 16), transpose, value.data());
  }
  void set_uniform_matrix_23d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix2x3dv(id_, location, static_cast<GLsizei>(value.size() / 6), transpose, value.data());
  }
  void set_uniform_matrix_32d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix3x2dv(id_, location, static_cast<GLsizei>(value.size() / 6), transpose, value.data());
  }
  void set_uniform_matrix_24d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix2x4dv(id_, location, static_cast<GLsizei>(value.size() / 8), transpose, value.data());
  }
  void set_uniform_matrix_42d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix4x2dv(id_, location, static_cast<GLsizei>(value.size() / 8), transpose, value.data());
  }
  void set_uniform_matrix_34d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
    glProgramUniformMatrix3x4dv(id_, location, static_cast<GLsizei>(value.size() / 12), transpose, value.data());
  }
  void set_uniform_matrix_43d(GLint location, const std::vector<GLdouble>& value, bool transpose)
  {
  ...
  void set_transform_feedback_varyings(const std::vector<std::string>& varyings, GLenum buffer_mode)
  {
